...
wireless_device_url = 'https://www.amazon.com/HBN-Wireless-Weatherproof-Grounded-Included/dp/B082TX3CV1?ref_=Oct_DLandingS_D_606946ae_60'
...
# // go to url
driver.get(wireless_device_url)
time.sleep(3)
...
# // This part is checking for links accessibility . but it failed couldn't understand the reason . just removed.
...
addchart = driver.find_element(by=By.NAME,value='submit.add-to-cart')
addchart.click()
time.sleep(3)

#alerttext = driver.switch_to.alert
#alerttext = alerttext.text
#print(alerttext)


#totalprice = driver.find_element(by=By.NAME,value='ewcCurrencySymbol').get_attribute('value')
#print(totalprice)
